...
***************************************************************************** */
        ...
        let headerCart = document.querySelector(".actions-header__cart");
        let headerCartQuantity = headerCart.querySelector("span");
        let speed = 1e3;
        function documentActions(e) {
            ...
            const itemDeals = document.querySelectorAll(".monthly-deals__item");
            itemDeals.forEach((itemDeal => {
                console.log(itemDeal);
                if (targetElement.closest("itemDeal")) addToCartMonthly();
            }));
        }
        function addToCart() {
        ...
        function addToCartMonthly() {
            const productImageMonthly = document.querySelector(".item-monthly-deal__image-ibg img");
            const imageMonthlyFly = productImageMonthly.cloneNode(true);
            const imageMonthlyFlyBlock = document.createElement("div");
            imageMonthlyFlyBlock.classList.add("image-monthly-fly");
            imageMonthlyFlyBlock.append(productImageMonthly);
            document.body.append(imageMonthlyFlyBlock);
            console.log(imageMonthlyFly);
            imageMonthlyFlyBlock.style.css = `\n\ttop: ${productImageMonthly.getBoundingClientRect().top}px;\n\tleft: ${productImageMonthly.getBoundingClientRect().left}px;\n\twidth ${productImageMonthly.offsetWidth}px;\n\theight ${productImageMonthly.offsetHeight}px;\n\t`;
            setTimeout((() => {
                imageMonthlyFlyBlock.style.cssText = `\n\t\t\ttop: ${headerCart.getBoundingClientRect().top}px;\n\t\t\tleft: ${headerCart.getBoundingClientRect().left}px;\n\t\t\twidth: 0;\n\t\t\theight: 0;\n\t\t\topacity: 0;\n\t\t\ttransition: all ${speed}ms;\n\t\t`;
            }), 5);
            setTimeout((() => {
                headerCartQuantity.innerHTML = ++headerCartQuantity.innerHTML;
                imageMonthlyFlyBlock.remove();
                console.log(imageMonthlyFlyBlock);
            }), speed);
        }
        window["FLS"] = true;
        isWebp();
